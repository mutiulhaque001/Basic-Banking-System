...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "banking system");
    if (!$conn) {
    ...
    <div id="hojaplz">
      <img src="https://cdn1.iconfinder.com/data/icons/basic-ui-elements-coloricon/21/36-512.png" id="menuBtn">
    </div>
